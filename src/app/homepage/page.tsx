    ...
    <div className="min-h-screen bg-gradient-to-br from-fuchsia-800 via-gray-900 to-fuchsia-950 text-shadow-gray-950 text-black">
      ...
      <nav className="px-6 py-4 flex items-center justify-between max-w-7xl mx-auto">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-2xl font-bold text-gray-900">Add Todo</span>
        </div>
        <button
        ...
        >
          {isHovered ? 'Get Started →' : 'Sign In / Register'}
        </button>
      </nav>
      ...
      <main className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-8">
            A todo list is your digital companion for capturing, organizing, and completing tasks. 
            Transform chaos into clarity with a simple, powerful way to manage everything you need to do.
          </p>
          <button
            onClick={handleAuthClick}
        ...
        <div className="bg-gradient-to-r from-gray-800 to-gray-600 box-border rounded-2xl shadow-gray-500 p-12 mb-20">
          ...
          <div className="prose prose-lg max-w-3xl mx-auto text-gray-300 ">
            <p className="mb-4">
              A todo list is a simple yet powerful productivity tool that helps you track tasks and 
              responsibilities. It's a written or digital record of things you need to accomplish, 
              allowing you to break down large goals into manageable, actionable items.
            </p>
            <p className="mb-4">
              Whether you're managing daily chores, planning a project, or organizing your career goals, 
              a todo list provides clarity and structure. By externalizing your tasks, you free up mental 
              space and reduce the stress of trying to remember everything.
            </p>
            <p>
              The beauty of a todo list lies in its simplicity: write it down, do it, check it off. 
              This satisfying cycle creates momentum and helps you build lasting productive habits.
            </p>
          </div>
        </div>
      </main>
      ...
      <footer className="block py-8 text-gray-600 text-center">
       <p>&copy; {new Date().getFullYear()} all right reserved Chiamaka Faith</p>
      </footer>
    </div>
  );
}
...
function FeatureCard({ icon, title, description, color }: FeatureCardProps) {
  ...
  return (
    <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
      <div className={`w-16 h-16 ${colorClasses[color as keyof typeof colorClasses]} rounded-lg flex items-center justify-center mb-4`}>
        {icon}
      </div>
